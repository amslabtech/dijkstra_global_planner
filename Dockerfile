...
RUN cd catkin_ws/src && git clone https://github.com/amslabtech/amsl_navigation_managers --depth=1 && git clone https://github.com/amslabtech/dijkstra_global_planner --depth=1
